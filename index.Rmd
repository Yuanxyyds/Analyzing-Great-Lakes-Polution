...
This is the website for Assignment 05 for JSC370. The three plots below shows:

1) Adjust Time Series for Mean Phosphorous Level of Great Lakes

2) Heapmap for Phosphorus Level over time by City

3) Interactive Leaflet showing the phosphorous level over multiple period by City
